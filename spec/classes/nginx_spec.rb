...
describe 'nginx' do
  ...
  describe "with defaults" do
    ...
    it { is_expected.to contain_anchor('nginx_legacy::begin') }
    it { is_expected.to contain_nginx__package.that_requires('Anchor[nginx_legacy::begin]') }
    it { is_expected.to contain_nginx__config.that_requires('Class[nginx_legacy::package]') }
    it { is_expected.to contain_nginx__service.that_subscribes_to('Anchor[nginx_legacy::begin]') }
    it { is_expected.to contain_nginx__service.that_subscribes_to('Class[nginx_legacy::package]') }
    it { is_expected.to contain_nginx__service.that_subscribes_to('Class[nginx_legacy::config]') }
    it { is_expected.to contain_anchor('nginx_legacy::end').that_requires('Class[nginx::service]') }
