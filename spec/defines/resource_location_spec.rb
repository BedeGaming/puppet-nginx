...
describe 'nginx_legacy::resource::location' do
  let :title do
    'rspec-test'
  end
  ...
  describe 'os-independent items' do
    ...
    context 'attribute resources' do
      ...
      context "vhost missing" do
        ...
        it { expect { is_expected.to contain_class('nginx_legacy::resource::location') }.to raise_error(Puppet::Error, /Cannot create a location reference without attaching to a virtual host/) }
      end
      ...
      context "location type missing" do
        ...
        it { expect { is_expected.to contain_class('nginx_legacy::resource::location') }.to raise_error(Puppet::Error, /Cannot create a location reference without a www_root, proxy, location_alias, fastcgi, uwsgi, stub_status, internal, or location_custom_cfg defined/) }
      end
      ...
      context "www_root and proxy are set" do
        ...
        it { expect { is_expected.to contain_class('nginx_legacy::resource::location') }.to raise_error(Puppet::Error, /Cannot define both directory and proxy in a virtual host/) }
      end
