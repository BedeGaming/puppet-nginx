# define: nginx_legacy::resource::map
#
...
# Sample Usage:
#
#  nginx_legacy::resource::map { 'backend_pool':
#    ensure    => present,
#    hostnames => true,
#    default   => 'ny-pool-1,
#    string    => '$http_host',
...
define nginx_legacy::resource::map (
  ...
  file { "${::nginx_legacy::config::conf_dir}/conf.d/${name}-map.conf":
    ensure  => $ensure_real,
