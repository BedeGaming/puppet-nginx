# define: nginx_legacy::resource::geo
#
...
# Sample Usage:
#
#  nginx_legacy::resource::geo { 'client_network':
#    ensure          => present,
#    ranges          => false,
#    default         => extra,
...
define nginx_legacy::resource::geo (
  ...
  file { "${::nginx_legacy::config::conf_dir}/conf.d/${name}-geo.conf":
    ensure  => $ensure_real,
